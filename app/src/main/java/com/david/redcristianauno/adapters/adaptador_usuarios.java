...
public class adaptador_usuarios extends RecyclerView.Adapter<adaptador_usuarios.ViewHolderDatos> {
    ...
    @NonNull
    @Override
    public adaptador_usuarios.ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull adaptador_usuarios.ViewHolderDatos holder, int i) {
    ...
    public class ViewHolderDatos extends RecyclerView.ViewHolder implements View.OnClickListener{
        public TextView tv_usuarios, tv_correo;
        public CheckBox checkusuarios;
